  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Risk Score */}
        <motion.div 
          className="bg-color1 dark:bg-gray-800 p-6 rounded-lg shadow-sm"
          variants={{
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-color1 mt-1">
                {riskMetricsWithScore.riskScore}/100
              </h3>
            </div>
            <div className="bg-color2 dark:bg-color8/20 p-3 rounded-lg">
              <AlertTriangle className="h-6 w-6 text-color8 dark:text-color8" />
            </div>
          </div>
          <div className="w-full bg-color2 dark:bg-gray-700 rounded-full h-2.5 mt-4">
            <div 
              className="bg-color8 h-2.5 rounded-full" 
      ...
      >
        ...
        <div className="bg-color1 dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-color2 dark:border-gray-700">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-color1">Liabilities Overview</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Track and manage your debts</p>
            </div>
            <div className="flex items-center space-x-2">
              <div className="px-3 py-1 rounded-full bg-color2 dark:bg-gray-700 text-gray-700 dark:text-color1 text-sm">
