...
export const RiskToleranceTab = () => {
  ...
  return (
    <div className="bg-color1 dark:bg-gray-800 rounded-lg shadow-sm p-6 space-y-8">
      {/* Header */}
      <div>
        <h2 className="text-2xl font-bold text-gray-900 dark:text-color1">Risk Tolerance Profile</h2>
      ...
      <div className="flex justify-end mt-6">
        <button
          className="px-6 py-3 rounded-xl bg-gradient-to-r from-color8 to-color8/80 text-color1 hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-color8 transition-all"
        >
          Update Risk Profile
        </button>
      </div>
